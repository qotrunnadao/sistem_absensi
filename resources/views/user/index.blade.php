...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            <div class="card-header bg-transparent border-bottom mt-0"> <a href="{{ route('user.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a> </div>
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="activity">
                        ...
                        <div class="post clearfix">
                            ...
                            {{-- <div class="btn-group">
								<a href="{{ route('user.fotomaster', $value->id) }}" class="btn btn-primary float-right">Ambil Foto Master</i></a>
                        </div> --}}
                    </div>
                </div>
            </div>
